...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteActivity.site'
        db.add_column('oxero_siteactivity', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['oxero.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteActivity.site'
        db.delete_column('oxero_siteactivity', 'site_id')
