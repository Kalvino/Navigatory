...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Distance.to_site'
        db.delete_column('oxero_distance', 'to_site_id')

        # Deleting field 'Distance.from_site'
        db.delete_column('oxero_distance', 'from_site_id')

        # Adding field 'Distance.point_a'
        db.add_column('oxero_distance', 'point_a',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['oxero.Site']),
                      keep_default=False)

        # Adding field 'Distance.point_b'
        db.add_column('oxero_distance', 'point_b',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['oxero.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Distance.to_site'
        db.add_column('oxero_distance', 'to_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['oxero.Site']),
                      keep_default=False)

        # Adding field 'Distance.from_site'
        db.add_column('oxero_distance', 'from_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['oxero.Site']),
                      keep_default=False)

        # Deleting field 'Distance.point_a'
        db.delete_column('oxero_distance', 'point_a_id')

        # Deleting field 'Distance.point_b'
        db.delete_column('oxero_distance', 'point_b_id')
