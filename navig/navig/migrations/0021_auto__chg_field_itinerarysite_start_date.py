...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItinerarySite.start_date'
        db.alter_column('oxero_itinerarysite', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ItinerarySite.start_date'
        db.alter_column('oxero_itinerarysite', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 30, 0, 0)))
