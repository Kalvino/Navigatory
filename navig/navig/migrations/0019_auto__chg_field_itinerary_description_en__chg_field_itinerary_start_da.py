...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Itinerary.description_en'
        db.alter_column('oxero_itinerary', 'description_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Itinerary.start_date'
        db.alter_column('oxero_itinerary', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Itinerary.description_en'
        db.alter_column('oxero_itinerary', 'description_en', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Itinerary.start_date'
        db.alter_column('oxero_itinerary', 'start_date', self.gf('django.db.models.fields.DateField')(default=''))
