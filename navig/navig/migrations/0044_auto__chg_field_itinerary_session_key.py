...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Itinerary.session_key'
        db.alter_column('oxero_itinerary', 'session_key', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Itinerary.session_key'
        db.alter_column('oxero_itinerary', 'session_key', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
