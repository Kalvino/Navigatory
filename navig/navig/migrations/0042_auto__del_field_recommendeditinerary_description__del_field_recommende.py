...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RecommendedItinerary.description'
        db.delete_column('oxero_recommendeditinerary', 'description')

        # Deleting field 'RecommendedItinerary.name'
        db.delete_column('oxero_recommendeditinerary', 'name')

        # Adding field 'RecommendedItinerary.name_en'
        db.add_column('oxero_recommendeditinerary', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'RecommendedItinerary.name_fr'
        db.add_column('oxero_recommendeditinerary', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecommendedItinerary.description_en'
        db.add_column('oxero_recommendeditinerary', 'description_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecommendedItinerary.description_fr'
        db.add_column('oxero_recommendeditinerary', 'description_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RecommendedItinerary.description'
        db.add_column('oxero_recommendeditinerary', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecommendedItinerary.name'
        db.add_column('oxero_recommendeditinerary', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'RecommendedItinerary.name_en'
        db.delete_column('oxero_recommendeditinerary', 'name_en')

        # Deleting field 'RecommendedItinerary.name_fr'
        db.delete_column('oxero_recommendeditinerary', 'name_fr')

        # Deleting field 'RecommendedItinerary.description_en'
        db.delete_column('oxero_recommendeditinerary', 'description_en')

        # Deleting field 'RecommendedItinerary.description_fr'
        db.delete_column('oxero_recommendeditinerary', 'description_fr')
    ...
    models = {
        ...
        'oxero.itinerary': {
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'session_key': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'oxero.recommendeditinerary': {
            'Meta': {'object_name': 'RecommendedItinerary'},
            'description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'routes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['oxero.Route']", 'symmetrical': 'False'})
        },
        'oxero.recommendeditinerarycombinations': {
            'Meta': {'object_name': 'RecommendedItineraryCombinations'},
            'distance': ('django.db.models.fields.IntegerField', [], {}),
            'ending_point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['oxero.Site']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nights': ('django.db.models.fields.IntegerField', [], {}),
            'recommended_itinerary': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['oxero.RecommendedItinerary']"}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['oxero.Site']", 'symmetrical': 'False'}),
            'starting_point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['oxero.Site']"})
        },
        'oxero.region': {
        ...
        'oxero.route': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'route': ('django.db.models.fields.IntegerField', [], {}),
            'segments': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['oxero.Segment']", 'symmetrical': 'False'})
        },
        'oxero.segment': {
        ...
        'oxero.site': {
            ...
            'has_airport': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'height': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
