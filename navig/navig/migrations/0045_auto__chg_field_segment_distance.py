...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Segment.distance'
        db.alter_column('oxero_segment', 'distance', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Segment.distance'
        db.alter_column('oxero_segment', 'distance', self.gf('django.db.models.fields.IntegerField')())
