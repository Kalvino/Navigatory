...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecommendedItinerary.width'
        db.add_column('oxero_recommendeditinerary', 'width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecommendedItinerary.height'
        db.add_column('oxero_recommendeditinerary', 'height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RecommendedItinerary.map'
        db.add_column('oxero_recommendeditinerary', 'map',
    ...
    def backwards(self, orm):
        # Deleting field 'RecommendedItinerary.width'
        db.delete_column('oxero_recommendeditinerary', 'width')

        # Deleting field 'RecommendedItinerary.height'
        db.delete_column('oxero_recommendeditinerary', 'height')

        # Deleting field 'RecommendedItinerary.map'
        db.delete_column('oxero_recommendeditinerary', 'map')
