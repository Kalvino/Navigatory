...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Itinerary.session_key'
        db.add_column('oxero_itinerary', 'session_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Itinerary.session_key'
        db.delete_column('oxero_itinerary', 'session_key')
