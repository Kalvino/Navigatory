...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SiteActivity.image'
        db.alter_column('oxero_siteactivity', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

        # Changing field 'SiteImage.image'
        db.alter_column('oxero_siteimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

        # Changing field 'ItineraryImage.image'
        db.alter_column('oxero_itineraryimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))
    ...
    models = {
        ...
        'oxero.itineraryimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('stdimage.fields.StdImageField', [], {'thumbnail_size': "{'width': 246, 'force': None, 'height': 160}", 'upload_to': "'images/%Y/%m/%d'", 'max_length': '255', 'blank': 'True', 'null': 'True', 'size': "{'width': 453, 'force': None, 'height': 294}"}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
