...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteComment'
        db.create_table('oxero_sitecomment', (
        ...
        db.send_create_signal('oxero', ['SiteComment'])


    def backwards(self, orm):
        # Deleting model 'SiteComment'
        db.delete_table('oxero_sitecomment')
