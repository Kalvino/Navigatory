...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExampleItineraryImage'
        db.create_table('oxero_exampleitineraryimage', (
            ...
            ('image', self.gf('stdimage.fields.StdImageField')(blank=True, max_length=255, null=True, upload_to='uploaded_images/%Y/%m/%d', size={'width': 246, 'force': True, 'height': 160})),
        ))
        db.send_create_signal('oxero', ['ExampleItineraryImage'])
        ...
        # Adding field 'ExampleItinerary.width'
        db.add_column('oxero_exampleitinerary', 'width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExampleItinerary.height'
        db.add_column('oxero_exampleitinerary', 'height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExampleItinerary.map'
        db.add_column('oxero_exampleitinerary', 'map',
    ...
    def backwards(self, orm):
        ...
        db.create_table('oxero_itineraryimage', (
            ...
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('image', self.gf('stdimage.fields.StdImageField')(size={'width': 246, 'force': True, 'height': 160}, upload_to='uploaded_images/%Y/%m/%d', max_length=255, null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        ...
        # Deleting model 'ExampleItineraryImage'
        db.delete_table('oxero_exampleitineraryimage')
        ...
        # Deleting field 'ExampleItinerary.width'
        db.delete_column('oxero_exampleitinerary', 'width')

        # Deleting field 'ExampleItinerary.height'
        db.delete_column('oxero_exampleitinerary', 'height')

        # Deleting field 'ExampleItinerary.map'
        db.delete_column('oxero_exampleitinerary', 'map')
