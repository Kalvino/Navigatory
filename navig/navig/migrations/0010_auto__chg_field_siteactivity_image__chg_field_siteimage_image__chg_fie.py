...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SiteActivity.image'
        db.alter_column('oxero_siteactivity', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=255))

        # Changing field 'SiteImage.image'
        db.alter_column('oxero_siteimage', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=255))

        # Changing field 'ItineraryImage.image'
        db.alter_column('oxero_itineraryimage', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=255))
