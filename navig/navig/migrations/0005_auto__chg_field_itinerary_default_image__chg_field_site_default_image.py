...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Itinerary.default_image'
        db.alter_column('oxero_itinerary', 'default_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['oxero.ItineraryImage']))

        # Changing field 'Site.default_image'
        db.alter_column('oxero_site', 'default_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['oxero.SiteImage']))

    def backwards(self, orm):

        # Changing field 'Itinerary.default_image'
        db.alter_column('oxero_itinerary', 'default_image_id', self.gf('django.db.models.fields.related.ForeignKey')(default='test', to=orm['oxero.ItineraryImage']))

        # Changing field 'Site.default_image'
        db.alter_column('oxero_site', 'default_image_id', self.gf('django.db.models.fields.related.ForeignKey')(default='test', to=orm['oxero.SiteImage']))
