...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Itinerary.default_image'
        db.delete_column('oxero_itinerary', 'default_image_id')

        # Deleting field 'Site.default_image'
        db.delete_column('oxero_site', 'default_image_id')


    def backwards(self, orm):
        # Adding field 'Itinerary.default_image'
        db.add_column('oxero_itinerary', 'default_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['oxero.ItineraryImage'], blank=True),
                      keep_default=False)

        # Adding field 'Site.default_image'
        db.add_column('oxero_site', 'default_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['oxero.SiteImage'], blank=True),
                      keep_default=False)
