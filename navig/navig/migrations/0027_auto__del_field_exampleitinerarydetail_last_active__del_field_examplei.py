...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExampleItineraryDetail.last_active'
        db.delete_column('oxero_exampleitinerarydetail', 'last_active')

        # Deleting field 'ExampleItineraryDetail.is_active'
        db.delete_column('oxero_exampleitinerarydetail', 'is_active')

        # Deleting field 'ExampleItineraryDetail.date'
        db.delete_column('oxero_exampleitinerarydetail', 'date')

        # Deleting field 'ExampleItineraryActivity.last_active'
        db.delete_column('oxero_exampleitineraryactivity', 'last_active')

        # Deleting field 'ExampleItineraryActivity.is_active'
        db.delete_column('oxero_exampleitineraryactivity', 'is_active')

        # Deleting field 'ExampleItineraryActivity.date'
        db.delete_column('oxero_exampleitineraryactivity', 'date')


    def backwards(self, orm):
        # Adding field 'ExampleItineraryDetail.last_active'
        db.add_column('oxero_exampleitinerarydetail', 'last_active',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=True, blank=True),
                      keep_default=False)

        # Adding field 'ExampleItineraryDetail.is_active'
        db.add_column('oxero_exampleitinerarydetail', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ExampleItineraryDetail.date'
        db.add_column('oxero_exampleitinerarydetail', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=True, blank=True),
                      keep_default=False)

        # Adding field 'ExampleItineraryActivity.last_active'
        db.add_column('oxero_exampleitineraryactivity', 'last_active',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2012, 9, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ExampleItineraryActivity.is_active'
        db.add_column('oxero_exampleitineraryactivity', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ExampleItineraryActivity.date'
        db.add_column('oxero_exampleitineraryactivity', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 9, 10, 0, 0), blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'oxero.exampleitineraryactivity': {
            'Meta': {'object_name': 'ExampleItineraryActivity'},
        ...
        'oxero.exampleitinerarydetail': {
            'Meta': {'object_name': 'ExampleItineraryDetail'},
