...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field region on 'Site'
        db.create_table('oxero_site_region', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('site', models.ForeignKey(orm['oxero.site'], null=False)),
            ('region', models.ForeignKey(orm['oxero.region'], null=False))
        ))
        db.create_unique('oxero_site_region', ['site_id', 'region_id'])


    def backwards(self, orm):
        # Removing M2M table for field region on 'Site'
        db.delete_table('oxero_site_region')
