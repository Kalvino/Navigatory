...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('oxero_siteactivity', 'image', self.gf('stdimage.fields.StdImageField')(max_length=255, null=True, upload_to='uploaded_images/%Y/%m/%d', size={'width': 246, 'force': True, 'height': 160}))

        # Changing field 'SiteImage.image'
        db.alter_column('oxero_siteimage', 'image', self.gf('stdimage.fields.StdImageField')(max_length=255, null=True, upload_to='uploaded_images/%Y/%m/%d', size={'width': 246, 'force': True, 'height': 160}))

        # Changing field 'ItineraryImage.image'
        db.alter_column('oxero_itineraryimage', 'image', self.gf('stdimage.fields.StdImageField')(max_length=255, null=True, upload_to='uploaded_images/%Y/%m/%d', size={'width': 246, 'force': True, 'height': 160}))

    def backwards(self, orm):

        # Changing field 'SiteActivity.image'
        db.alter_column('oxero_siteactivity', 'image', self.gf('stdimage.fields.StdImageField')(size={'width': 246, 'force': None, 'height': 160}, upload_to='uploaded_images/%Y/%m/%d', max_length=255, null=True))

        # Changing field 'SiteImage.image'
        db.alter_column('oxero_siteimage', 'image', self.gf('stdimage.fields.StdImageField')(size={'width': 246, 'force': None, 'height': 160}, upload_to='uploaded_images/%Y/%m/%d', max_length=255, null=True))

        # Changing field 'ItineraryImage.image'
        db.alter_column('oxero_itineraryimage', 'image', self.gf('stdimage.fields.StdImageField')(size={'width': 246, 'force': None, 'height': 160}, upload_to='uploaded_images/%Y/%m/%d', max_length=255, null=True))
