...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SiteComment.name'
        db.delete_column('oxero_sitecomment', 'name')

        # Deleting field 'SiteComment.email'
        db.delete_column('oxero_sitecomment', 'email')

        # Adding field 'SiteComment.user'
        db.add_column('oxero_sitecomment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SiteComment.name'
        db.add_column('oxero_sitecomment', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'SiteComment.email'
        db.add_column('oxero_sitecomment', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)

        # Deleting field 'SiteComment.user'
        db.delete_column('oxero_sitecomment', 'user_id')
