...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteActivityImage'
        db.create_table('oxero_siteactivityimage', (
            ...
            ('site_activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.SiteActivity'])),
            ('image', self.gf('stdimage.fields.StdImageField')(blank=True, max_length=255, null=True, upload_to='uploaded_images/%Y/%m/%d', size={'width': 266, 'force': True, 'height': 175})),
        ))
        db.send_create_signal('oxero', ['SiteActivityImage'])


    def backwards(self, orm):
        # Deleting model 'SiteActivityImage'
        db.delete_table('oxero_siteactivityimage')
