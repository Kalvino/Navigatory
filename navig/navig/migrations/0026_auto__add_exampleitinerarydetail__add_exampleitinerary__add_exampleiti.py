...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExampleItinerary'
        db.create_table('oxero_exampleitinerary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('last_active', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('oxero', ['ExampleItinerary'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ExampleItinerary'
        db.delete_table('oxero_exampleitinerary')
