...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecommendedItineraryCombinations'
        db.create_table('oxero_recommendeditinerarycombinations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recommended_itinerary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.RecommendedItinerary'])),
            ('distance', self.gf('django.db.models.fields.IntegerField')()),
            ('nights', self.gf('django.db.models.fields.IntegerField')()),
            ('starting_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['oxero.Site'])),
            ('ending_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['oxero.Site'])),
        ))
        db.send_create_signal('oxero', ['RecommendedItineraryCombinations'])

        # Adding M2M table for field sites on 'RecommendedItineraryCombinations'
        db.create_table('oxero_recommendeditinerarycombinations_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recommendeditinerarycombinations', models.ForeignKey(orm['oxero.recommendeditinerarycombinations'], null=False)),
            ('site', models.ForeignKey(orm['oxero.site'], null=False))
        ))
        db.create_unique('oxero_recommendeditinerarycombinations_sites', ['recommendeditinerarycombinations_id', 'site_id'])


    def backwards(self, orm):
        # Deleting model 'RecommendedItineraryCombinations'
        db.delete_table('oxero_recommendeditinerarycombinations')

        # Removing M2M table for field sites on 'RecommendedItineraryCombinations'
        db.delete_table('oxero_recommendeditinerarycombinations_sites')
