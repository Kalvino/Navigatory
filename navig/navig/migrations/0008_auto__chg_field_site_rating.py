...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.rating'
        db.alter_column('oxero_site', 'rating', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Site.rating'
        db.alter_column('oxero_site', 'rating', self.gf('django.db.models.fields.FloatField')())
