...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('oxero_siteactivity', 'image', self.gf('stdimage.fields.StdImageField')(thumbnail_size={'width': 246, 'force': None, 'height': 160}, upload_to='uploaded_images/%Y/%m/%d', max_length=255, null=True, size={'width': 453, 'force': None, 'height': 294}))

        # Changing field 'SiteImage.image'
        db.alter_column('oxero_siteimage', 'image', self.gf('stdimage.fields.StdImageField')(thumbnail_size={'width': 246, 'force': None, 'height': 160}, upload_to='uploaded_images/%Y/%m/%d', max_length=255, null=True, size={'width': 453, 'force': None, 'height': 294}))

        # Changing field 'ItineraryImage.image'
        db.alter_column('oxero_itineraryimage', 'image', self.gf('stdimage.fields.StdImageField')(thumbnail_size={'width': 246, 'force': None, 'height': 160}, upload_to='uploaded_images/%Y/%m/%d', max_length=255, null=True, size={'width': 453, 'force': None, 'height': 294}))

    def backwards(self, orm):

        # Changing field 'SiteActivity.image'
        db.alter_column('oxero_siteactivity', 'image', self.gf('stdimage.fields.StdImageField')(thumbnail_size={'width': 246, 'force': None, 'height': 160}, upload_to='images/%Y/%m/%d', max_length=255, null=True, size={'width': 453, 'force': None, 'height': 294}))

        # Changing field 'SiteImage.image'
        db.alter_column('oxero_siteimage', 'image', self.gf('stdimage.fields.StdImageField')(thumbnail_size={'width': 246, 'force': None, 'height': 160}, upload_to='images/%Y/%m/%d', max_length=255, null=True, size={'width': 453, 'force': None, 'height': 294}))

        # Changing field 'ItineraryImage.image'
        db.alter_column('oxero_itineraryimage', 'image', self.gf('stdimage.fields.StdImageField')(thumbnail_size={'width': 246, 'force': None, 'height': 160}, upload_to='images/%Y/%m/%d', max_length=255, null=True, size={'width': 453, 'force': None, 'height': 294}))
    ...
    models = {
        ...
        'oxero.itineraryimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('stdimage.fields.StdImageField', [], {'thumbnail_size': "{'width': 246, 'force': None, 'height': 160}", 'upload_to': "'uploaded_images/%Y/%m/%d'", 'max_length': '255', 'blank': 'True', 'null': 'True', 'size': "{'width': 453, 'force': None, 'height': 294}"}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
