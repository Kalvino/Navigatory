...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Site.ubilat'
        db.delete_column('oxero_site', 'ubilat')

        # Deleting field 'Site.ubilon'
        db.delete_column('oxero_site', 'ubilon')

        # Adding field 'Site.location_lat'
        db.add_column('oxero_site', 'location_lat',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=7),
                      keep_default=False)

        # Adding field 'Site.location_lon'
        db.add_column('oxero_site', 'location_lon',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=7),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Site.ubilat'
        db.add_column('oxero_site', 'ubilat',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=7),
                      keep_default=False)

        # Adding field 'Site.ubilon'
        db.add_column('oxero_site', 'ubilon',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=7),
                      keep_default=False)

        # Deleting field 'Site.location_lat'
        db.delete_column('oxero_site', 'location_lat')

        # Deleting field 'Site.location_lon'
        db.delete_column('oxero_site', 'location_lon')
    ...
    models = {
        ...
        'oxero.distance': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'point_a': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['oxero.Site']"}),
            'point_b': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['oxero.Site']"})
        },
        ...
        'oxero.itinerarysite': {
            'Meta': {'ordering': "['order']", 'object_name': 'ItinerarySite'},
        ...
        'oxero.site': {
            ...
            'location_lat': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '7'}),
            'location_lon': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '7'}),
