...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItinerarySite.hotel'
        db.delete_column('oxero_itinerarysite', 'hotel_id')


    def backwards(self, orm):
        # Adding field 'ItinerarySite.hotel'
        db.add_column('oxero_itinerarysite', 'hotel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.SiteHotel'], null=True, blank=True),
                      keep_default=False)
