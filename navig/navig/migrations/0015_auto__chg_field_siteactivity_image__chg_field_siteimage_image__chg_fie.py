...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('oxero_siteactivity', 'image', self.gf('stdimage.fields.StdImageField')(max_length=255, null=True, upload_to='uploaded_images/%Y/%m/%d', size={'width': 246, 'force': None, 'height': 160}))

        # Changing field 'SiteImage.image'
        db.alter_column('oxero_siteimage', 'image', self.gf('stdimage.fields.StdImageField')(max_length=255, null=True, upload_to='uploaded_images/%Y/%m/%d', size={'width': 246, 'force': None, 'height': 160}))

        # Changing field 'ItineraryImage.image'
        db.alter_column('oxero_itineraryimage', 'image', self.gf('stdimage.fields.StdImageField')(max_length=255, null=True, upload_to='uploaded_images/%Y/%m/%d', size={'width': 246, 'force': None, 'height': 160}))
    ...
    models = {
        ...
        'oxero.itineraryimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('stdimage.fields.StdImageField', [], {'blank': 'True', 'max_length': '255', 'null': 'True', 'upload_to': "'uploaded_images/%Y/%m/%d'", 'size': "{'width': 246, 'force': None, 'height': 160}"}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
