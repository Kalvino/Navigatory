...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExampleItinerary.name_en'
        db.add_column('oxero_exampleitinerary', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'ExampleItinerary.name_fr'
        db.add_column('oxero_exampleitinerary', 'name_fr',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExampleItinerary.name_en'
        db.delete_column('oxero_exampleitinerary', 'name_en')

        # Deleting field 'ExampleItinerary.name_fr'
        db.delete_column('oxero_exampleitinerary', 'name_fr')
