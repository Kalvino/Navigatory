...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.width'
        db.add_column('oxero_site', 'width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Site.height'
        db.add_column('oxero_site', 'height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Site.map'
        db.add_column('oxero_site', 'map',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Site.width'
        db.delete_column('oxero_site', 'width')

        # Deleting field 'Site.height'
        db.delete_column('oxero_site', 'height')

        # Deleting field 'Site.map'
        db.delete_column('oxero_site', 'map')
