...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('oxero_segment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('route', self.gf('django.db.models.fields.IntegerField')()),
            ('segment', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('oxero', ['Segment'])

        # Adding M2M table for field sites on 'Segment'
        db.create_table('oxero_segment_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('segment', models.ForeignKey(orm['oxero.segment'], null=False)),
            ('site', models.ForeignKey(orm['oxero.site'], null=False))
        ))
        db.create_unique('oxero_segment_sites', ['segment_id', 'site_id'])


    def backwards(self, orm):
        # Deleting model 'Segment'
        db.delete_table('oxero_segment')

        # Removing M2M table for field sites on 'Segment'
        db.delete_table('oxero_segment_sites')
