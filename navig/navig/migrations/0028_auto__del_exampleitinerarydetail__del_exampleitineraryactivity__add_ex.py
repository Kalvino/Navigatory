...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ExampleItineraryDetail'
        db.delete_table('oxero_exampleitinerarydetail')

        # Deleting model 'ExampleItineraryActivity'
        db.delete_table('oxero_exampleitineraryactivity')

        # Adding model 'ExampleItinerarySiteDetail'
        db.create_table('oxero_exampleitinerarysitedetail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('example_itinerary_site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.ExampleItinerarySite'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('oxero', ['ExampleItinerarySiteDetail'])

        # Adding model 'ExampleItinerarySite'
        db.create_table('oxero_exampleitinerarysite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('last_active', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('example_itinerary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.ExampleItinerary'])),
            ('day_number', self.gf('django.db.models.fields.IntegerField')()),
            ('from_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['oxero.Site'])),
            ('to_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['oxero.Site'])),
        ))
        db.send_create_signal('oxero', ['ExampleItinerarySite'])

        # Adding model 'ExampleItinerarySiteActivity'
        db.create_table('oxero_exampleitinerarysiteactivity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('example_itinerary_site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.ExampleItinerarySite'])),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.SiteActivity'])),
        ))
        db.send_create_signal('oxero', ['ExampleItinerarySiteActivity'])

        # Deleting field 'Itinerary.is_example'
        db.delete_column('oxero_itinerary', 'is_example')

        # Deleting field 'ExampleItinerary.day_number'
        db.delete_column('oxero_exampleitinerary', 'day_number')

        # Deleting field 'ExampleItinerary.to_site'
        db.delete_column('oxero_exampleitinerary', 'to_site_id')

        # Deleting field 'ExampleItinerary.from_site'
        db.delete_column('oxero_exampleitinerary', 'from_site_id')

        # Adding field 'ExampleItinerary.name'
        db.add_column('oxero_exampleitinerary', 'name',
    ...
    def backwards(self, orm):
        # Adding model 'ExampleItineraryDetail'
        db.create_table('oxero_exampleitinerarydetail', (
            ('example_itinerary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.ExampleItinerary'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('oxero', ['ExampleItineraryDetail'])

        # Adding model 'ExampleItineraryActivity'
        db.create_table('oxero_exampleitineraryactivity', (
            ('example_itinerary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.ExampleItinerary'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oxero.SiteActivity'])),
        ))
        db.send_create_signal('oxero', ['ExampleItineraryActivity'])

        # Deleting model 'ExampleItinerarySiteDetail'
        db.delete_table('oxero_exampleitinerarysitedetail')

        # Deleting model 'ExampleItinerarySite'
        db.delete_table('oxero_exampleitinerarysite')

        # Deleting model 'ExampleItinerarySiteActivity'
        db.delete_table('oxero_exampleitinerarysiteactivity')

        # Adding field 'Itinerary.is_example'
        db.add_column('oxero_itinerary', 'is_example',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ExampleItinerary.day_number'
        db.add_column('oxero_exampleitinerary', 'day_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ExampleItinerary.to_site'
        db.add_column('oxero_exampleitinerary', 'to_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['oxero.Site']),
                      keep_default=False)

        # Adding field 'ExampleItinerary.from_site'
        db.add_column('oxero_exampleitinerary', 'from_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['oxero.Site']),
                      keep_default=False)

        # Deleting field 'ExampleItinerary.name'
        db.delete_column('oxero_exampleitinerary', 'name')
